from bc_engine import Shader, Vec2, Vec3, Vec4, Quat; instancing_shader=Shader(language=Shader.GLSL, vertex='''#version 140
...
if __name__ == '__main__':
    from bc_engine import Ursina, Entity, EditorCamera, Vec3, color, application, time, Cone
    import random
