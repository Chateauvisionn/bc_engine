...
from bc_engine import texture_importer
...
class HotReloader(Entity):
    ...
    def reload_shaders(self):
        ...
        for shader in bc_engine.shader.imported_shaders:
...
if __name__ == '__main__':
    ...
    # test
    from bc_engine.shaders import lit_with_shadows_shader
    from bc_engine.prefabs.primitives import *
    ...
    from bc_engine.lights import DirectionalLight
