...
class Text(Entity):
    ...
    def text(self, text):
        ...
        # clear stuff
        from bc_engine.ursinastuff import destroy  # needed to destroy inline images
    ...
    def background(self, value):
        if value == True:
            ...
            from bc_engine.ursinastuff import destroy
    ...
    def create_background(self, padding=size*2, radius=size, color=bc_engine.color.black66):
        from bc_engine import Quad, destroy
