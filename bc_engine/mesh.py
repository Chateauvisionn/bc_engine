...
from bc_engine.scripts.generate_normals import generate_normals
from bc_engine.scripts.project_uvs import project_uvs
from bc_engine.scripts.colorize import colorize
...
class Mesh(NodePath):
    ...
    def save(self, name='', path=application.compressed_models_folder):
        ...
        if name.endswith('ursinamesh'):
            ...
            from bc_engine.mesh_importer import ursina_mesh_to_obj
            import os
