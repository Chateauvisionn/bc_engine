...
from bc_engine import color, application
from bc_engine.scene import instance as scene    # for toggling collider visibility
...
class Window(WindowProperties):
    ...
    def make_editor_gui(self):     # called by main after setting up camera and application.development_mode
        from bc_engine import camera, Entity, Text, Button, ButtonList, Func, Tooltip, held_keys, mouse
        import time
    ...
    def update_aspect_ratio(self):
        ...
        from bc_engine import camera, window, application
    ...
    def render_mode(self, value):
        ...
        if value == 'wireframe':
            ...
            from bc_engine.shaders import normals_shader
            for e in [e for e in scene.entities if e.model and e.alpha]:
